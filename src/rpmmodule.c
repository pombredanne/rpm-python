...
- Create a transaction set.\n" },
	...
	NULL },
    { "readHeaderListFromFD", (PyCFunction) rpmHeaderFromIO, METH_VARARGS|METH_KEYWORDS,
	NULL },
    { "readHeaderListFromFile", (PyCFunction) rpmHeaderFromIO, METH_VARARGS|METH_KEYWORDS,
	NULL },
